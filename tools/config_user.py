...
class ConfigTool:
    def __init__(self, root_dir):    
        parser = argparse.ArgumentParser(
            ...
            -> Execute create command to create the user folder and subfolders, and place the profile file.
               --> The create command copies the basic profile file into the user config folder
    ...
    def cnf_create(self, args):
        source = os.path.join(root_dir, 'configfiles', 'core.json')
        print('source=', source)
        ...
        if not os.path.isdir(self.user.configfiles_dir):
            ...
            os.makedirs(self.user.configfiles_dir)
