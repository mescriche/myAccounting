...
In order to make operation easy, it's been created \verb!admin_session.py! file, which open the database and creates basic variables like db, user, accounts, tree, etc, which are useful when having to fix issues by hand.

\subsection{How to import admin\_session} \label{admin_session}
\begin{verbatim}
>> pipenv shell
>> python
